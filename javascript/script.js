...
function updateTimer() {
  const targetDate = new Date("january 1, 2025 10:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '542923510664'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '542923510664'; // Número para el primer botón
